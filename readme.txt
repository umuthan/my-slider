...
A Wordpress plugin to show an animated slider on pages via shortcode or widget.

== Description ==

Wordpress Slider Module
...
**bullets**: to shows bullets under slider

**nav-buttons**: to shows nav buttons (prev, next)

**timer**: duration between slides
...
1. Upload the plugin files to the `/wp-content/plugins/my-slider` directory, or install the plugin through the WordPress plugins screen directly.
2. Activate the plugin through the 'Plugins' screen in WordPress
3. Use the shortcode or widget described in this README
